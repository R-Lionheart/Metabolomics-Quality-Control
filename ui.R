      ...
      mainPanel(width = 10,
        tabsetPanel(type = "tabs",
          tabPanel("Information", h2("Using the Ingalls Lab Quality Control", align = "center"), 
            ...
            p("2. Switch to the appropriate tab.", style = "font-family: 'times'; font-size:18px"),
            p("3. Upload the correct files for your machine type.", style = "font-family: 'times'; font-size:18px"),
            p("4. Set your quality control parameters.", style = "font-family: 'times'; font-size:18px"),
            h2("LCMS Setup"),
            hr(),
      ...
      tabPanel("QExactive",
        ...
        fluidRow(
          ...
          column(2,
            ...
            br(),
            br(),
            # TODO (rlionheart): Clarify the blank table. 
            helpText("Create a table of blank references."),
            ...
            br(),
            br(),
            # TODO (rlionheart): Clarify the blank flags 
