...
ui <- fluidPage(useShinyjs(),
  ...
  # Title Panel -----------------------------------------------------------------
    ...
    # QE tabPanel -----------------------------------------------------------------
      tabPanel("QExactive",
        fluidRow(
          column(4, helpText("For best results, start on the left and add each column of flags sequentially."),
        ...
        fluidRow(
          ...
          column(2,
            ...
            helpText("Transform original character column classes to numeric values."),
